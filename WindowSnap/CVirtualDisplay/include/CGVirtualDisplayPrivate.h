...
//
// Private CoreGraphics virtual-display declarations.
// Derived from Stengo/DeskPad (MIT), originally VirtualDisplayExp by Khaos Tian.
// Runtime implementations live in system frameworks; this header only declares them.
//
